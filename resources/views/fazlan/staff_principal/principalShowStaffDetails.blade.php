                ...
                <fieldset class="col-md-11" >
                            ...
                            <div class="container1 col-md-6">
                                ...
                                <div class="form-group" >
                                    <label for="">Full Name</label>
                                        ...
                                        <input type="text" class="form-control" id="" placeholder="" name="fullName" value="{{$val->name}}" size="10px" disabled>

                                </div>
                                <div class="form-group">
                                    <label for="">Permanent Address</label>

                                    <input type="text" class="form-control" id="" placeholder="" name="permanantAddress" value="{{$val->perAddr}}" disabled>

                                </div>
                                <div class="form-group">
                                    <label for="">Current Address</label>

                                    <input type="text" class="form-control" id="" placeholder="" name="currentAddress" value="{{$val->curAddr}}" disabled>

                                </div>
                                <div class="form-group">
                                    <label for="">Nationality</label>

                                    <input type="text" class="form-control" id="" placeholder="" name="nationality" value="{{$val->nationality}}"  disabled>
                                </div>
                        </div>
                        ...
                        <div class="container3 col-md-12">
                            ...
                            <tr><div class="form-group">
                                    ...
                                    <td><div class="col-md-12"><input style="width:200px;" type="text" class="form-control"  name="nic" value="{{$val->nic}}" disabled></div>
                                    </td>
                                </div>
                                <div class="form-group">
                                    <td><div class="col-md-12"><label for="">Date of Birth</label></div></td>
                                    <td><div class="col-md-10"><input style=style="width:230px;" type="date" class="form-control"  name="dob" value="{{$val->dob}}" disabled></div>
                                ...
                                <tr><div class="form-group">
                                    ...
                                    <td><div class="col-md-12"><input style=style="width:230px;" type="text" class="form-control"name="phone" value="{{$val->phone}}" disabled>

                                    </td>
                                </div>
                                <div class="form-group">
                                    <td><div class="col-md-12"><label for="">Email </label></div></td>
                                    <td><div class="col-md-10"><input style="width:230px;" type="email" class="form-control" name="email" value="{{$val->email}}" disabled>
                            ...
                            <tr>
                                ...
                                <td><div class="col-md-10" style="width:200px;">
                                        <input style="width:230px;" type="text" class="form-control" name="position" value="{{$val->pos}}" disabled>
                                    </div>
                                </div>
                                </td>
                                <td><div class="col-md-12">
                                ...
                                <td><div class="col-md-10" style="width:200px;">
                                        <input style="width:230px;" type="text" class="form-control" name="gender" value="{{$val->gender}}" disabled>
                                    </div>
                                </div>
                                </td>
                            </tr>
