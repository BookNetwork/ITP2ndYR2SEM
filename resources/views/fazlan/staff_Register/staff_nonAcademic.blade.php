...
<!-------------- PERSONAL DETAILS ------------------>
<form method="post" action="save_nonAcademic" enctype="multipart/form-data">
    <div class="col-md-12">
        ...
        <fieldset class="col-md-11">
                ...
                <div class="container1 col-md-6">
                        <div class="form-group" style="width:35%">
                            ...
                            <input type="text" class="form-control text" id="regNo" placeholder="" name="regNo" value="<?php echo 'NS'?>">
                ...
                <center><div class="container2 col-md-4">
                    <div class="panel panel-primary" style="height:300px;width:220px">
                        ...
                        <div class="panel-body">
                            <div class="">
                               ...
                               <input type="file" class="btn btn-primary" style="width:200px;" name="image" id="uploadImage" value=" "  onchange="PreviewImage();">
                ...
                <div class="container3 col-md-12">
                    ...
                    <tr><div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <td><div class="col-md-10"><input style="width:200px;" type="date" class="form-control" id="" placeholder="" name="dob" max="<?php $date = date("Y"); $year = $date - 19; echo $year.'-12-31'; ?>"></div>
                            @if ($errors->has('dob'))
                                  <span class="help-block">
                    ...
                    <tr>
                        ...
                        @if ($errors->has('department'))
                              <span class="help-block">
                                  <strong style="color:red;padding-left:25px;">{{ $errors->first('department') }}</strong>
                              </span>
                        @endif</td>
                    </tr>
                    <tr>
...
<!-------------- Any further Information relevant to the Application ------------------>
                        ...
                        <button type="submit" class="btn btn-primary" style="width:100px;margin:0px 0px 20px 50px;" id="button1" onclick="enableButton2()" enable>Save</button>
